...
function HeroText() {
  return (
    <>
        <h3 className="text-4xl md:text-6xl lg:text-[4.em] xl:text-[4.5em] font-extrabold leading-[1.4em] md:leading-[1.4em] lg:leading-[1.3em] text-left md:tracking-[0.5em] tracking-[0.4em] bg-clip-text bg-gradient-to-br from-[#ebe5dd] to-[#7f424a] uppercase z-10 text-transparent lg:tracking-[0.2em]">Faster Sneaker Inventory Lists</h3>
